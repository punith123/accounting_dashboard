...
public class DebtorShipmentsFullllBoardMismatch extends ActionSupport{
	...
	private void buildRTOTotalMismacth() {
		...
		setRtoLineitems(fullBoard.getRTOShipmentsFullMismatch("debtor"));
	...
	private void buildDeliveredTotalMismacth() {
		// TODO Auto-generated method stub
		FullBoardBuilder fullBoard = new FullBoardBuilder();
		setDeliveredLineitems(fullBoard.getDeliveredShipmentsFullMismatch("debtor"));
	}
